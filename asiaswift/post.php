...
$payUrl="http://tgw.bfopay.com/payindex";//借贷混合
$TerminalID = "10000001"; 
...
<form id="form1" name="form1" method="post" action="<?php echo $payUrl; ?>">
        ...
        <input type='hidden' name='PageUrl' value="http://smfos.com.au/asiaswift/merchant_url.php" />
        <input type='hidden' name='ReturnUrl' value="http://smfos.com.au/asiaswift/return_url.php" />
