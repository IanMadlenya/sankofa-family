...
<div class="w3-top">
  <ul class="w3-navbar" id="myNavbar">
    ...
    <li class="w3-hide-small w3-right">
        ...
        <a href="#" class="w3-padding-large w3-white w3-hover-green w3-text-dark-grey"><?php echo $current_user->user_login ?></a>
        <?php else: ?>
      <a href="/wp-admin" class="w3-padding-large w3-white w3-hover-green w3-text-dark-grey">登录</a>
        <?php endif; ?>
    </li>
  </ul>
</div>
