  ...
  <ul class="w3-navbar" id="myNavbar">
    ...
    <li class="w3-hide-small w3-right">
      <?php if ( is_user_logged_in() ): ?>
        <a href="#" class="w3-padding-large w3-black w3-hover-green w3-text-light-grey wp-opacity2"><?php echo $current_user->user_login ?></a>
        <?php else: ?>
      <a href="/wp-admin" class="w3-padding-large w3-black w3-hover-green w3-text-light-grey wp-opacity2">登录</a>
        <?php endif; ?>
    </li>
  </ul>
</div>